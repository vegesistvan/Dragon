...
IMPLEMENT_DYNAMIC(CDisplayInfo, CDialogEx)
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CDisplayInfo::CDisplayInfo(CWnd* pParent /*=NULL*/)
	: CDialogEx(CDisplayInfo::IDD, pParent)
{
...
void CDisplayInfo::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_INFO, m_editCtrl);
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CDisplayInfo, CDialogEx)
	ON_WM_SETFOCUS()
END_MESSAGE_MAP()
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL CDisplayInfo::OnInitDialog()
{
	CDialogEx::OnInitDialog();

//	CString title = L"Egy ember különbözõ bejegyzéseinek vizsgálata, összevonása";
...
\r\n\
A felhasználó három összevonási algoritmus közül választhat, a laza, közepes és a szigorú ellenõrzés közül.\r\n\
\r\n\
...
*/
	...
	m_editCtrl.SetWindowTextW( *m_text);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CDisplayInfo::OnSetFocus(CWnd* pOldWnd)
{
