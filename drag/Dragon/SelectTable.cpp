...
BOOL CSelectTable::OnInitDialog()
{
	...
	m_tableNameSelected		= theApp.GetProfileString( L"dragon", L"tableNameSelected", L"" );
	m_tableNumberSelected	= theApp.GetProfileInt( L"dragon", L"tableNumber", 1 );
...
//			m_ListCtrl.SetItemText( nItem, 3, str );
	...
	theApp.keress( str, &m_ListCtrl, m_orderix, 0, true);
	return TRUE;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void CSelectTable::OnBnClickedOk()
{
	...
	theApp.WriteProfileInt( L"dragon", L"tableNumber", m_tableNumberSelected );
	CDialogEx::OnOK();
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
