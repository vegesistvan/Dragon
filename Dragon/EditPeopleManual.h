...
// CEditPeopleManual dialog

class CEditPeopleManual : public CDialogEx
{
	DECLARE_DYNAMIC(CEditPeopleManual)

public:
	CEditPeopleManual(CWnd* pParent = NULL);   // standard constructor
	virtual ~CEditPeopleManual();

// Dialog Data
	enum { IDD = IDD_EDIT_PEOPLE_MANUAL };
