...
IMPLEMENT_DYNAMIC(CCheckGenerations1, CDialogEx)
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CCheckGenerations1::CCheckGenerations1(CWnd* pParent /*=NULL*/)
	: CDialogEx(CCheckGenerations1::IDD, pParent)
{

}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CCheckGenerations1::~CCheckGenerations1()
{
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CCheckGenerations1::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CCheckGenerations1, CDialogEx)
//	ON_BN_CLICKED(IDOK, &CCheckGenerations1::OnBnClickedOk)
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL CCheckGenerations1::OnInitDialog()
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CCheckGenerations1::OnBnClickedOk()
{
*/
...
//	m_command = L"SELECT tableNumber, lineNumber, generation, source, rowid, last_name, first_name FROM people ORDER BY lineNumber";
	...
	if( !theApp.query( m_command ) ) return true;
	...
	for( UINT i = 0; i < theApp.m_recordset->RecordsCount(); ++i, theApp.m_recordset->MoveNext() )
	{
		...
		if( tableNumber.Compare( theApp.m_recordset->GetFieldString( G_TABLENUMBER ) ) )  // új tábla kezdõdik
		{
			...
			if( !theApp.query1( m_command ) ) return true;
