...
ON_COMMAND(ID_CONTRACTED, &CSamePeople::OnContracted)
ON_COMMAND(ID_NOTCONTRACTED, &CSamePeople::OnNotcontracted)
ON_COMMAND(ID_ALL, &CSamePeople::OnAll)
END_MESSAGE_MAP()
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
int CSamePeople::sameBirth( int i, int j )
{
...
// -1:	mindkkettõnek van dátuma, és azok különbözzõk
// 1:	mindkettõnek van dátuma és azok egyenlõk
int CSamePeople::sameDeath( int i, int j )
{
...
int CSamePeople::sameFather( int i, int j )
{
	CString father1;
	CString father2;
	CString birth1;
...
// -1:	mindkettõ meg van adva, és azok különbözzõk
// 1:	mindkettõ meg van adva és azok egyenlõk
int CSamePeople::sameMother( int i, int j )
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int CSamePeople::sameSpouse( int i, int j )
{
	SPOUSES2 sp;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int CSamePeople::sameKids( int i, int j )
{
	KIDS kids;
	CString rowid1 = vSame.at(i).rowid;
	CString rowid2 = vSame.at(j).rowid;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int CSamePeople::timeConflict( int i, int j )
{
	return 0;
	int ret;
	CString rowidI = vSame.at(i).rowid;
...
//
int CSamePeople::dateDiff( CString date1, CString date2, int month  )
{
	CString str1;
	CString str2;
	CString d1;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CString CSamePeople::getDateI( CString dateS, int month ) 
{
	CString dateI;
	CString datum;
	CString modifier;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int CSamePeople::dateSame( CString date1, CString date2 )
{
...
void CSamePeople::listRecord(  int i, int cnt, int volt )
{
	CString color;
	int colorIndex;
	int col;
...
void CSamePeople::to_v_Replace( int replace, int by )
{
	REPLACE R;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// a v_Replace vektorban összegyûjtött emberek törlése 
void CSamePeople::unite( int iter )
{
	CString	sex_id;
	CString rowid;
	int		source;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::sameMarriages( int iter )
{
	CString spouse1_id;
	CString spouse2_id;
	CString spouses1;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::listSameVector( CString name )
{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::listColumnHeader( int i )
{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::getSpouses( CString rowid, CString sex_id )
{
	CString spouse_id;
	CString spouse;
	CString spouse2;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::getKids( CString rowid, CString sex_id )
{
	CString child;
	KIDS	kids;
...

void CSamePeople::findSamePeople( CString firstName, CString lastName, BOOL replace )
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::collectSameName( CString name )
{
	SAME same;
	sameClear( &same );
	vSame.clear();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
CString CSamePeople::getChildren( CString rowid, CString sex_id, std::vector<KIDS>* vektor )
{
	CString child_id;
	CString child;
	CString names( L"" );
...
*/
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::title( int contracted )
{
	CString caption;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::OnAll()
{
	fillTable( 2 );
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::OnContracted()
{
	fillTable( 1 );
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::OnNotcontracted()
{
	fillTable( 0 );
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSamePeople::fillTable( int contracted )
{
	int	nItem = 0;
	int fileLength;
	int position;
