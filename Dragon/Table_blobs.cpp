...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CTableBlobs::OnSize(UINT nType, int cx, int cy)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CTableBlobs::OnSizing(UINT fwSide, LPRECT pRect)
{
...
void CTableBlobs::fillBlobTable()
{
	...
	for( UINT i = 0; i < theApp.m_recordsetBlob->RecordsCount(); ++i, theApp.m_recordsetBlob->MoveNext() )
	{
		...
		case MARRIAGE:
			table = L"házasság";
			m_command.Format( L"SELECT spouse1_id, spouse2_id FROM marriages WHERE rowid='%s'", rowid  );
			if( !theApp.query( m_command ) ) return;
		...
		m_ListCtrl.SetItemText( nItem, B_SIZE, thousend( sizeBlob ) );
	...
	str.Format( L"%s (%s bájt)", m_filterText, thousend( sizeTotal ) ); 
	SetWindowText( str );
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
