...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
void CFaDlg::OnProgramrol()
{
	CAboutDlg dlgAbout;
	dlgAbout.DoModal();
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CFaDlg::OnSize(UINT nType, int cx, int cy) 
{
	CDialog::OnSize(nType, cx, cy);
	EASYSIZE_RESIZE() //automatikus meretezeshez kell
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CFaDlg::OnSizing(UINT nSide, LPRECT lpRect)
{
	CDialog::OnSizing(nSide, lpRect);
	EASYSIZE_MINSIZE(430,314,nSide,lpRect); 
}
*/
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
