...
BEGIN_MESSAGE_MAP(CTableGaTables, CDialogEx)
	...
	ON_EN_CHANGE(IDC_SEARCH, &CTableGaTables::OnChangeSearch)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CTableGaTables::OnSize(UINT nType, int cx, int cy)
{
	CDialogEx::OnSize(nType, cx, cy);
	EASYSIZE_RESIZE()
}
void CTableGaTables::OnSizing(UINT fwSide, LPRECT pRect)
{
...
//	while( pos )
	...
	outputFileSpec.Format( L"%s\\%s_%I64d.html", theApp.m_workingDirectory, fileName, theApp.getPresentTime() );
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CTableGaTables::OnChangeSearch()
{
	CString	search;
