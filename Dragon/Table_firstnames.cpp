...
//	ON_COMMAND(ID_UDATE_REPLACE, &CTableFirstnames::OnUdateReplace)
...
//	ON_MESSAGE(WM_FILL_TABLE, OnFillTable)
END_MESSAGE_MAP()
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void CTableFirstnames::OnSizing(UINT fwSide, LPRECT pRect)
{
