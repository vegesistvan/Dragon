...
void CSelectPeople::fillTable()
{
	...
	{
		m_ListCtrl.InsertItem( i, m_recordset->GetFieldString( PEOPLE_ROWID ) );
		m_ListCtrl.SetItemText( i, M_LAST_NAME, m_recordset->GetFieldString( PEOPLE_LAST_NAME ) );
		m_ListCtrl.SetItemText( i, M_FIRST_NAME, m_recordset->GetFieldString( PEOPLE_FIRST_NAME ) );
		m_ListCtrl.SetItemText( i, M_BIRTH_DATE, m_recordset->GetFieldString( PEOPLE_BIRTH_DATE ) );
		m_ListCtrl.SetItemText( i, M_DEATH_DATE, m_recordset->GetFieldString( PEOPLE_DEATH_DATE ) );
		m_ListCtrl.SetItemText( i, M_COMMENT, m_recordset->GetFieldString( PEOPLE_COMMENT ) );
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSelectPeople::OnChangeSearch()
{
	CString	search;
...
void CSelectPeople::OnBnClickedOk()
{
	...
	m_rowid	= _wtoi( m_ListCtrl.GetItemText( nItem, M_ROWID ) );
	CDialogEx::OnOK();
}
