...
//	SetWindowPos(&wndTopMost, 0, 0, 0, 0, SWP_NOMOVE | SWP_NOSIZE);
	...
	m_ListCtrl.InsertColumn( M_EMPTY,L"",LVCFMT_RIGHT, 40, -1,COL_HIDDEN );
	m_ListCtrl.InsertColumn( M_ROWID,L"",LVCFMT_RIGHT, 40, -1,COL_NUM );
	m_ListCtrl.InsertColumn( M_VALUE,		L"",LVCFMT_LEFT, 295, -1,COL_TEXT);
	...
	{
		if( m_ListCtrl.GetItemText(i,M_VALUE) == m_selected )		// a kurzort a kiválasztott könyvhöz tartozó étékre állítja
		{
...
void CSelectOne::fillTable() 
{
	...
	if( m_dbfile == 1 )
	{
		...
		for(i=0;i<m_recordset->RecordsCount();++i,m_recordset->MoveNext())
		{
			...
			m_ListCtrl.SetItemText( ix, M_ROWID, (LPTSTR)m_recordset->GetFieldString(0) );
			m_ListCtrl.SetItemText( ix, M_VALUE, (LPTSTR)m_recordset->GetFieldString(1) );
		}
	}
	else
	{
		...
		{
			ix = m_ListCtrl.InsertItem( i,(LPTSTR) L" " );
			m_ListCtrl.SetItemText( ix, M_ROWID, (LPTSTR)theApp.m_recordsetSystem->GetFieldString(0) );
			m_ListCtrl.SetItemText( ix, M_VALUE, (LPTSTR)theApp.m_recordsetSystem->GetFieldString(1) );
		}
	}
	m_ListCtrl.SetSortOrder( (int)m_orderix );
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// A ListCtrl táblázatban karakterenként követi a begépelt nevet (m_search)
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSelectOne::OnChangeSearch() 
{
	CString	search;
...
void CSelectOne::OnOK() 
{
	...
	m_selected	= m_ListCtrl.GetItemText(n,M_VALUE);
	m_id		= m_ListCtrl.GetItemText(n,M_ROWID);
	CDialog::OnOK();
}