// CUniteRelatives.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CUniteRelatives, CDialogEx)
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CUniteRelatives::CUniteRelatives(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_UNITE_RELATIVES, pParent)
{

}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
CUniteRelatives::~CUniteRelatives()
{
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CUniteRelatives::DoDataExchange(CDataExchange* pDX)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CUniteRelatives, CDialogEx)

	ON_NOTIFY(NM_DBLCLK, IDC_LIST1, &CUniteRelatives::OnDblclkList1)
	ON_NOTIFY(NM_DBLCLK, IDC_LIST2, &CUniteRelatives::OnDblclkList2)
	ON_NOTIFY(NM_DBLCLK, IDC_LIST3, &CUniteRelatives::OnDblclkList3)
	ON_NOTIFY(NM_DBLCLK, IDC_LIST4, &CUniteRelatives::OnDblclkList4)
	

	ON_NOTIFY(NM_CUSTOMDRAW, IDC_LIST1, &CUniteRelatives::OnCustomdrawList1)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_LIST2, &CUniteRelatives::OnCustomdrawList2)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_LIST3, &CUniteRelatives::OnCustomdrawList3)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_LIST4, &CUniteRelatives::OnCustomdrawList4)
END_MESSAGE_MAP()
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
BOOL CUniteRelatives::OnInitDialog()
{
...
bool CUniteRelatives::getRelatives(CString sorszam, CString rowid, NONUNITED* n)
{
	...
	m_command.Format(L"SELECT spouse1_id, spouse2_id FROM marriages WHERE spouse1_id='%s' OR spouse2_id = '%s'", rowid, rowid );
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CUniteRelatives::OnDblclkList1(NMHDR* pNMHDR, LRESULT* pResult)
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CUniteRelatives::OnDblclkList2(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMITEMACTIVATE pNMItemActivate = reinterpret_cast<LPNMITEMACTIVATE>(pNMHDR);
	int nItem = pNMItemActivate->iItem;
	int	nCol = pNMItemActivate->iSubItem;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CUniteRelatives::OnDblclkList3(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMITEMACTIVATE pNMItemActivate = reinterpret_cast<LPNMITEMACTIVATE>(pNMHDR);
	int nItem = pNMItemActivate->iItem;
	int	nCol = pNMItemActivate->iSubItem;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CUniteRelatives::OnDblclkList4(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMITEMACTIVATE pNMItemActivate = reinterpret_cast<LPNMITEMACTIVATE>(pNMHDR);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CUniteRelatives::OnCustomdrawList1(NMHDR* pNMHDR, LRESULT* pResult)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CUniteRelatives::OnCustomdrawList2(NMHDR* pNMHDR, LRESULT* pResult)
{
	NMLVCUSTOMDRAW* pLVCD = reinterpret_cast<NMLVCUSTOMDRAW*>(pNMHDR);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CUniteRelatives::OnCustomdrawList3(NMHDR* pNMHDR, LRESULT* pResult)
{
	NMLVCUSTOMDRAW* pLVCD = reinterpret_cast<NMLVCUSTOMDRAW*>(pNMHDR);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CUniteRelatives::OnCustomdrawList4(NMHDR* pNMHDR, LRESULT* pResult)
{
	NMLVCUSTOMDRAW* pLVCD = reinterpret_cast<NMLVCUSTOMDRAW*>(pNMHDR);
