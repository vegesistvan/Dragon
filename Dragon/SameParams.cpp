...
//  SetWindowPos(&wndTopMost, 0, 0, 0, 0, SWP_NOMOVE | SWP_NOSIZE);
	...
	for( UINT i = 0; i < theApp.m_recordset->RecordsCount(); ++i, theApp.m_recordset->MoveNext() )
	{
		...
		m_ListCtrl.SetItemText( i, L_FAMILYNUMBER, theApp.m_recordset->GetFieldString( PEOPLE_FAMILYNUMBER ) );
		m_ListCtrl.SetItemText( i, L_TABLENUMBER, theApp.m_recordset->GetFieldString( PEOPLE_TABLENUMBER ) );
		m_ListCtrl.SetItemText( i, L_LINENUMBER, theApp.m_recordset->GetFieldString( PEOPLE_LINENUMBER ) );
		m_ListCtrl.SetItemText( i, L_SOURCE, theApp.m_recordset->GetFieldString( PEOPLE_SOURCE ) );
		m_ListCtrl.SetItemText( i, L_GENERATION, theApp.m_recordset->GetFieldString( PEOPLE_GENERATION ) );
		m_ListCtrl.SetItemText( i, L_BIRTH, theApp.m_recordset->GetFieldString( PEOPLE_BIRTH_DATE ) );
		m_ListCtrl.SetItemText( i, L_DEATH, theApp.m_recordset->GetFieldString( PEOPLE_DEATH_DATE ) );

		father_id	= theApp.m_recordset->GetFieldString( PEOPLE_FATHER_ID );
		mother_id	= theApp.m_recordset->GetFieldString( PEOPLE_MOTHER_ID );
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSameParams::OnSize(UINT nType, int cx, int cy)
{
	CDialogEx::OnSize(nType, cx, cy);
	EASYSIZE_RESIZE()
}
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void CSameParams::OnSizing(UINT fwSide, LPRECT pRect)
{
